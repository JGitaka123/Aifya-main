"""Add employee-to-staff auto-sync trigger

Revision ID: 007_employee_staff_sync
Revises: 006_referral_templates
Create Date: 2026-05-25
"""
from alembic import op

revision = "007_employee_staff_sync"
down_revision = "006"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    op.execute("DROP TRIGGER IF EXISTS trg_sync_employee_to_staff ON employees;")
    op.execute("DROP FUNCTION IF EXISTS sync_employee_to_staff();")
